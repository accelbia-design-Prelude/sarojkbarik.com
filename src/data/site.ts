...
export const SPECIES: Species[] = [
  {
    id: 1,
    num: "001",
    name: "Heterostemma barikiana",
    family: "Apocyanceae",
    location: "Ukhrul, Manipur",
    elev: "1,911 m",
    year: 2019,
    isNew: true,
    image: "/heterostemma_barikiana.png",
    link: "https://phytotaxa.mapress.com/pt/article/view/phytotaxa.419.2.11",
    note: "The specific epithet is given in honour of Prof. S. K. Barik.",
  },
  {
    id: 2,
    num: "002",
    ...
    family: "Poaceae",
    location: "Maitoli Glacier, Uttarakhand",
    elev: "2,560 m",
    year: 2021,
    isNew: true,
...
export const PUBLICATIONS: Publication[] = [
  ...
  },
  {
    yr: 2025,
    title:
      "Transcriptomic insights into elevation-dependent gene expression in Rhododendron anthopogon D.Don",
    authors:
      "Mangral, Z.A., Islam, S.U., Majeed, A., Tariq, L., Goel, S., Barik, S.K., Dar, T.U.H.",
  ...
  },
  {
    yr: 2025,
    title:
      "Metagenomic profiling of cyanide-degrading microbial communities in steel-industry wastewater",
  ...
  },
  {
    yr: 2025,
    title:
      "Genetic diversity analysis of Rhododendron arboreum in western Himalaya indicates altitudinal population differentiation",
    authors:
      "Sorokhaibam, S.S., Jhajhariya, M., Baishya, R., Barik, S.K., Goel, S., Tandon, R.",
    journal: "The Nucleus",
    if: 2.6,
  ...
  },
  {
    yr: 2025,
    title:
      "Evaluation of in-vivo anti-lithiatic activity of polyherbal formulation in ameliorating calcium oxalate kidney stones",
    authors:
      "Misra, A., Chaudhary, M.K., Rawat, P., et al., Barik, S.K., Srivastava, S.",
    journal: "Fitoterapia",
    if: 2.6,
  ...
  },
  {
    ...
    journal: "Environmental Sustainability 7:427–437",
    if: 2.8,
  ...
  },
  {
    ...
    journal: "Biomass and Bioenergy 183:107142",
    if: 5.8,
  ...
  },
  {
    yr: 2024,
    title:
      "Evaluating bioeconomic potential of Phyllostachys mannii Gamble and Chimonocalamus griffithianus from north-eastern India",
    authors: "Kharlyngdoh, E., Barik, S.K.",
    journal: "Biomass and Bioenergy 182:107076",
    if: 5.8,
  ...
  },
  {
    ...
    journal: "Proceedings of the National Academy of Sciences 120(45)",
    if: 11.1,
  ...
  },
  {
    ...
    journal: "Current Forestry Reports 9(6):473–489",
    if: 8.6,
...
export const FELLOWSHIPS: Fellowship[] = [
  ...
  { yr: "2024", name: "FNA", full: "Indian National Science Academy" },
  {
    yr: "2020",
    name: "FNAAS",
    full: "National Academy of Agricultural Sciences",
  },
  ...
  { yr: "2018", name: "FNASc", full: "National Academy of Sciences, India" },
  {
    yr: "2012",
    name: "ISEB",
    full: "Indian Society of Environmental Botanists",
  },
  {
    yr: "2003",
    name: "LEAD",
    full: "Leadership for Environment & Development",
  },
];
...
export const AWARDS: Award[] = [
  ...
  {
    yr: "2020",
    name: "Prof. R.N. Tandon Memorial Award",
    org: "National Academy of Sciences, India",
  },
  {
    yr: "2019",
    name: "Prof. Birbal Sahni Medal",
    org: "Indian Botanical Society",
  },
  {
    yr: "2019",
    name: "Biodiversity Lecture Award",
    org: "National Academy of Sciences, India",
  },
  {
    yr: "2016",
    name: "Dr. Mopuri Brahmam Memorial Award",
    org: "for biodiversity conservation",
  },
...
export const VIDEOS: Video[] = [
  {
    id: "8zqh378dWd4",
    title:
      "Meghalaya: President Murmu Appoints Dr Saroj Kanta Barik as NEHU Vice-Chancellor",
    source: "Northeast Live",
    year: 2026,
  },
  {
    id: "BIhugPrmM-4",
    title: "Ecosystem & Biodiversity — India's real wealth",
    source: "RSTV Eureka",
    year: 2021,
  },
  {
    id: "0rrk341nFLM",
    title: "Address at the Rose & Gladiolus Flower Show",
    source: "CSIR-NBRI Lucknow",
    year: 2021,
  },
  {
    id: "EDXI3E2Lqxk",
    title: "Inaugural Ceremony of ICPEP-7",
    source: "CSIR-NBRI · 30 Nov 2025",
    year: 2025,
  },
  {
    id: "hG0taakGjoA",
    title: "Biodiversity Conclave",
    source: "Ten News Live",
    year: 2022,
  },
];
...
export const EXPERIENCE: Appointment[] = [
  {
    ...
    org: "North-Eastern Hill University, Shillong",
  },
  {
    yr: "2025–2026",
  ...
  {
    yr: "2020–2022",
    role: "Director (concurrent)",
    org: "CSIR-Indian Institute of Toxicology Research, Lucknow",
  },
  {
    yr: "2016–2022",
    role: "Director",
    org: "CSIR-National Botanical Research Institute, Lucknow",
  },
  {
    yr: "2014–2016",
    role: "Head, Department of Botany",
    org: "North-Eastern Hill University, Shillong",
  },
  {
    yr: "2006–",
    role: "Professor of Botany",
    org: "North-Eastern Hill University, Shillong",
  },
  {
    yr: "2001–2006",
    role: "Reader/Associate Professor, Department of Botany",
    org: "North-Eastern Hill University, Shillong",
  },
  {
    yr: "1997–2001",
    role: "Lecturer, Center for Environmental Studies",
    org: "North-Eastern Hill University, Shillong",
  },
  {
    yr: "1995–1997",
    role: "Scientist",
    org: "State Forest Research Institute, Arunachal Pradesh",
  },
];
